...
import "./TeamLead_Customer_Add_Page.css";
...
//---- { component imports } ------------------------------------------
import { TEAMLEAD_CUSTOMER_ADD_PAGE_ACTIONS } from "../../../../pageActions/TeamLeadPageActions/CustomerActions/TEAMLEAD_CUSTOMER_ADD_PAGE_ACTIONS";
//----------------------------------------------------------------------


export function TEAMLEAD_CUSTOMER_ADD_PAGE(){
...
//----------------------------------------------------------------------
    ...
    return(
        <>
         <TEAMLEAD_CUSTOMER_ADD_PAGE_ACTIONS Props={Props} />
        </>
    )
}
