...
import { TEAMLEAD_MY_PROFILE_PAGE_ACTIONS } from '../../../pageActions/TeamLeadPageActions/MyprofileActions/TEAMLEAD_MY_PROFILE_PAGE_ACTIONS';
//---------------------------------------------------------------



export function TEAMLEAD_MY_PROFILE_PAGE(){
...
const Props =  {tableOuterBox,headingOuterBox,headingProps,dialogProps,personalAndTeamOuterBox,personalDataProps,signOutButton}
    ...
    return(
        ...
        <CardComponent props={{...infoPageOuterCard}}>
             ...
             <TEAMLEAD_MY_PROFILE_PAGE_ACTIONS Props={Props}/>
