...
import "./Admin_Employee_Details_Page.css";
...
import { ADMIN_EMPLOYEE_PAGE_ACTIONS } from "../../../../pageActions/AdminPageActions/EmployeeActions/ADMIN_EMPLOYEE_PAGE_ACTIONS";
import { CardComponent } from "../../../../BasicComponents/CardComponent";
//---------------------------------------------------------------



export function ADMIN_EMPLOYEE_PAGE(){
...
const Props =  {pageOuterBox,headingOuterBox,headingProps,dialogProps,personalOuterBox,personalDataProps,workAndJobOuterBox,workDetailProps,revenueDetailProps,pendingJobProps}
    ...
    return(
        ...
        <CardComponent props={{...outerCard}}>
              ...
              <ADMIN_EMPLOYEE_PAGE_ACTIONS Props={Props}/>
