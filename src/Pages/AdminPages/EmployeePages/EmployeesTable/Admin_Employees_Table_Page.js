...
import "./Admin_Employees_Table_Page.css";
//--------------------------------------------------------------
...
import { ADMIN_EMPLOYEES_TABLE_ACTIONS } from "../../../../pageActions/AdminPageActions/EmployeeActions/ADMIN_EMPLOYEES_TABLE_ACTIONS";
//---------------------------------------------------------------



export function ADMIN_EMPLOYEES_TABLE_PAGE(){
...
const Props = {tableHeadingAndButtonBox,tableHeading,tableOuterCard,addButton,tableProps};
    ...
    return(
        <>
         <ADMIN_EMPLOYEES_TABLE_ACTIONS Props={Props} />
        </>
    )
}
