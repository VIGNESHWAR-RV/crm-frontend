...
import "./Admin_Customers_Table_Page.css";
//--------------------------------------------------------------
...
import { ADMIN_CUSTOMERS_TABLE_ACTIONS } from "../../../../pageActions/AdminPageActions/CustomerActions/ADMIN_CUSTOMERS_TABLE_PAGE_ACTIONS";
//---------------------------------------------------------------


export function ADMIN_CUSTOMERS_TABLE_PAGE(){
    ...
    return(
        <>
          <ADMIN_CUSTOMERS_TABLE_ACTIONS Props={Props} />
        </>
    )
}
