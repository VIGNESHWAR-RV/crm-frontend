import "./Admin_Customer_Details_Page.css";
...
//--------- { action imports } ----------------------------------
import { ADMIN_CUSTOMER_DETAILS_PAGE_ACTIONS } from "../../../../pageActions/AdminPageActions/CustomerActions/ADMIN_CUSTOMER_DETAILS_PAGE_ACTIONS";
//---------------------------------------------------------------



export function ADMIN_CUSTOMERS_PAGE(){
...
//---- Heading Component ----------------------------------------------------------
    ...
    const headingProps = {saveButton,cancelButton,editFabButton,deleteButton,titleSkeleton,buttonSkeleton,dataField,fields};
...
const outerCard = {sx:{m:2,mb:5,overflowX:"auto",borderRadius:"1.5rem"},
    ...
    return(
        ...
        <CardComponent props={{...outerCard}}>
              ...
              <ADMIN_CUSTOMER_DETAILS_PAGE_ACTIONS Props={Props}/>
