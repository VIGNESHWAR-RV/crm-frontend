...
//--- { styleSheet,react,router-dom imports } -----------------
...
import { EMPLOYEE_DASHBOARD_PAGE_ACTIONS } from "../../../pageActions/EmployeePageActions/DashboardActions/EMPLOYEE_DASHBOARD_PAGE_ACTIONS";
//---------------------------------------------------------------



export function EMPLOYEE_DASHBOARD_PAGE(){
...
const notesUpdatePath = "/employee/dashboard/notes";
...
const navPath="/employee/customers/";
...
const Props = {dashBoardOuterDiv,graphAndNotesDiv,graphProps,notesProps,infoAndJobsDiv,infoProps,pendingJobProps}
    ...
    return(
        <EMPLOYEE_DASHBOARD_PAGE_ACTIONS Props={Props} />
    )
}
