...
import "./Employee_CustomerInfo.css";
...
import { EMPLOYEE_CUSTOMER_DETAILS_PAGE_ACTIONS } from "../../../../pageActions/EmployeePageActions/CustomerActions/EMPLOYEE_CUSTOMER_DETAILS_PAGE_ACTIONS";
//---------------------------------------------------------------



export function EMPLOYEE_CUSTOMER_INFO_PAGE(){
...
return(
    <>
     <CardComponent props={{...outerCard}}>
        ...
        <EMPLOYEE_CUSTOMER_DETAILS_PAGE_ACTIONS Props={Props}/>
