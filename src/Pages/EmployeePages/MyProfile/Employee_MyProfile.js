...
import { EMPLOYEE_MY_PROFILE_PAGE_ACTIONS } from "../../../pageActions/EmployeePageActions/MyProfileActions/EMPLOYEE_MY_PROFILE_PAGE_ACTIONS";
//---------------------------------------------------------------


export function EMPLOYEE_MYPROFILE_PAGE(){

    
    // --- Common Data ----------------------------------------------------------------------------
                                        
        //regex patterns
        const regex = {firstName:"^[a-zA-Z0-9. ]{2,}$",
...
const Props =  {tableOuterBox,headingOuterBox,headingProps,dialogProps,personalAndTeamOuterBox,personalDataProps,signOutButton}
    ...
    return(
        <CardComponent props={{...infoPageOuterCard}}>
           ...
           <EMPLOYEE_MY_PROFILE_PAGE_ACTIONS Props={Props}/>
