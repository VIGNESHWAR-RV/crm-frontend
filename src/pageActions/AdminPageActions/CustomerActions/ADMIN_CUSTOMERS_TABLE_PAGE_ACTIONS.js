...
export function ADMIN_CUSTOMERS_TABLE_ACTIONS({Props}){
    ...
    const [data] = useFetchAction({componentMounted,path:`/admin/customers/table`,method:"GET",header:{},body:{},role:"admin" });
