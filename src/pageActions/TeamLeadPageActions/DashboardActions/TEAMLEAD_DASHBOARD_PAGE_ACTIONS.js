...
import { TEAMLEAD_NOTES_CONTAINER_ACTION } from "../Notes/TEAMLEAD_NOTES_CONTAINER_ACTION";
//-------------------------------------------------------------------------------
...
export function TEAMLEAD_DASHBOARD_PAGE_ACTIONS({Props}){
    ...
    const [data] = useFetchAction({componentMounted,path:"/teamLead/dashboard",method:"GET",header:{},body:{},role:"teamLead"})
    ...
    return(
          <BoxComponent props={{...dashBoardOuterDiv}} >
               ...
               <BoxComponent props={{...graphAndNotesDiv}} >
                  ...
                  <TEAMLEAD_NOTES_CONTAINER_ACTION notesProps={notesProps} notesData={dashboardData.notesData} />
