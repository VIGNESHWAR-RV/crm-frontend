...
export const TEAMLEAD_NOTES_CONTAINER_INITIALSTATES = {
...
export const TEAMLEAD_NOTES_CONTAINER_ACTIONS = {
...
export const TEAMLEAD_NOTES_CONTAINER_REDUCER =(states,{eventType,...payLoad})=>{

     switch (eventType){

           case TEAMLEAD_NOTES_CONTAINER_ACTIONS.NOTES_CHANGE:{
           ...
           case TEAMLEAD_NOTES_CONTAINER_ACTIONS.LOADING: {
           ...
           case TEAMLEAD_NOTES_CONTAINER_ACTIONS.NOTES_SAVED: {
           ...
           case TEAMLEAD_NOTES_CONTAINER_ACTIONS.CLEAR_NOTES:{
           ...
           case TEAMLEAD_NOTES_CONTAINER_ACTIONS.FIRST_TIME_SET:{
