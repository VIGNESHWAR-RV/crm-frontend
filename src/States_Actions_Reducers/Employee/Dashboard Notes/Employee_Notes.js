...
export const EMPLOYEE_NOTES_CONTAINER_INITIALSTATES = {
...
export const EMPLOYEE_NOTES_CONTAINER_ACTIONS = {
...
export const EMPLOYEE_NOTES_CONTAINER_REDUCER =(states,{eventType,...payLoad})=>{

     switch (eventType){

           case EMPLOYEE_NOTES_CONTAINER_ACTIONS.NOTES_CHANGE:{
           ...
           case EMPLOYEE_NOTES_CONTAINER_ACTIONS.LOADING: {
           ...
           case EMPLOYEE_NOTES_CONTAINER_ACTIONS.NOTES_SAVED: {
           ...
           case EMPLOYEE_NOTES_CONTAINER_ACTIONS.CLEAR_NOTES:{
           ...
           case EMPLOYEE_NOTES_CONTAINER_ACTIONS.FIRST_TIME_SET:{
